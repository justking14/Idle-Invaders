...
var upgradeTree = [
     {
          id: 'Upgrade1',
          unlocked: false,
          description: "Adds a second shooter",
          parents: [],
          siblings: [],
          children: ["Upgrade2"],
          cost: 50
     },
     {
          id: 'Upgrade2',
          unlocked: false,
          description: "Adds a third shooter",
...
var strengthTree = [
     {
          id: 'Strength1',
          unlocked: false,
          description: "Increases damage done by bullets",
          parents: [],
          siblings: [],
          children: ["Strength2"],
          cost: 25
     },
     {
          id: 'Strength2',
          unlocked: false,
          description: "Increases size of bullets",
     ...
     },
     {
          id: 'Strength3',
          unlocked: false,
          description: "Bullets sometimes explode on impact",
...
var speedTree = [
...

     {
          id: 'Speed1',
          unlocked: false,
          description: "Increases how quickly bullets are fired",
          parents: [],
          siblings: [],
          children: ["Speed2a", "Speed2b"],
          cost: 5
     },
     {
          id: 'Speed2a',
          unlocked: false,
          description: "Further increases how quickly bullets are fired",
     ...
     },
     {
          id: 'Speed2b',
          unlocked: false,
          description: "Increases how quickly bullets move",
...

     {
          id: 'Speed3a',
          unlocked: false,
          description: "Even more quickly increases the rate bullets are fired",
     ...
     },
     {
          id: 'Speed3b',
          unlocked: false,
          description: "Decreases enemy movement speed",
     ...
     },
     {
          id: 'Speed4',
          unlocked: false,
          description: "Decreases enemy spawn rate",
          ...
          children: [
               {
                    id: 'Speed2a',
                    unlocked: false,
                    description: "Increases how quickly bullets are fired again",
